...
$(function() {
        var bookmark = {
            data: [{
                name: '建全官网',
                link: 'https://jianquan888.github.io/',
                box_shadow: '#F18033',
                icon: 'img/log.png',
            }, {
                name: '三五影视',
                ...
                name: '猫咪影视',
                link: 'https://xmaomi.top/',
                box_shadow: '#AC6E2F',
                icon: 'img/xda.png',
            }, {
                name: '蓝光影视',
                link: 'https://www.lgyy.cc/',
                box_shadow: '#D7191A',
                icon: 'img/sspai.png',
            }, {
                name: '大米影视',
                ...
                name: '歪巴影视',
                link: 'https://waipian8.com/',
                box_shadow: '#62677b',
                icon: 'img/shuziweiba.png',
            }, {
                name: '三五官网',
                link: 'https://www.555kan.net/',
                box_shadow: '#7C5DC7',
                icon: 'img/ding.png',
            }, {
                name: '歪影官网',
    ...
    $(document).click(function(e) {
            ...
            for (var i = 0; i < search.data.length; i++) {
                if (id == search.data[i].name) {
                    ...
                    document.getElementById("Select").innerHTML = "<hr>建全超级导航 <img src='img/search-change.svg?v=2ae7ab8'>";
...
var time = d.getHours();
if (time < 24) {
    document.getElementById("title").innerHTML = "建全超级导航 | Good evening";
}
if (time < 18) {
    document.getElementById("title").innerHTML = "建全超级导航 | Good afternoon";
}
if (time < 12) {
    document.getElementById("title").innerHTML = "建全超级导航 | Good morning";
}
if (time < 5) {
    document.getElementById("title").innerHTML = "建全超级导航 | Stay up late again";
}
//title问候语结束

//导航、引擎选择器
function select() {
    $('#folder').css('display') == 'block' ? ($('#folder').css('display', 'none'), $('#nav').css('display', 'block'), document.getElementById("Select").innerHTML = "<hr>搜索引擎 <img src='img/search-change.svg?v=2ae7ab8'>") : ($('#nav').css('display', 'none'), $('#folder').css('display', 'block'), document.getElementById("Select").innerHTML = "<hr>建全超级导航 <img src='img/search-change.svg?v=2ae7ab8'>");
}
//导航、引擎选择器结束
